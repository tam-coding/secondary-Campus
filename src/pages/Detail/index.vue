          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="mins" @click="skuNum=skuNum>0?skuNum-1:1">-</a>
              </div>
              <div class="add">
...
export default {
  ...
  computed: {
    ...mapGetters("detail", ["skuInfo", "categoryView", "spuSaleAttrList"]),
    //如果服务器数据还没回来 此时skuImageList是undefined 子组件读取undefined的属性会报错 以下是为了避免
    skuImageList() {
